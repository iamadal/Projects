 $(document).ready(function() {
        var priceList = [
		    ...
		    { label: "কাচ্চি বিরিয়ানি(ফুল: মাংশ-৩পিস, আলু-১পিস): ৬০০ টাকা", 			value: "a31", sellingPrice: 600, actualPrice: 550 },
		    { label: "কাচ্চি বিরিয়ানি(ফুল: মাংশ-৩পিস+ডিম ১ পিস+আলু ১ পিস): ৬২০ টাকা", 	value: "a32", sellingPrice: 620, actualPrice: 570 },
		    ...
		    { label: "পেয়াজু(ছোট ২ পিস): ২০ টাকা", value: "a67", sellingPrice: 20, actualPrice: 16 },
		    ...
		    { label: "ফ্রেঞ্চ টোস্ট: ৬০ টাকা", value: "a74", sellingPrice: 60, actualPrice: 44 },
		    ...
		    { label: "পাকা আম: ৬৫ টাকা", 	value: "a83", sellingPrice: 65, actualPrice: 55 },
		    ...
		    { label: "পাকা পেপে: ৪০ টাকা", value: "a95", sellingPrice: 40, actualPrice: 30 },
		    ...
		    { label: "কাপদই(মিষ্টি/টক) / দই(মিষ্টি/টক): ৫০ টাকা", value: "a111", sellingPrice: 50, actualPrice: 40 },
		    { label: "শাহি জর্দা: ৮০ টাকা", value: "a112", sellingPrice: 80, actualPrice: 70 },
		    { label: "চমচম/রসগোল্লা: ৫০ টাকা", value: "a113", sellingPrice: 50, actualPrice: 42 },
		    ...
		    { label: "পেপের শরবত: ৬০ টাকা", value: "a123", sellingPrice: 60, actualPrice: 60 },
		    ...
		    { label: "চা/দুধ চা: ১৫ টাকা", value: "a134", sellingPrice: 15, actualPrice: 13 },
	        ...
	        { label: "কাজুবাদাম : ৭০ টাকা", value: "a138", sellingPrice: 70, actualPrice: 70 }, //Unofficial		
	        { label: "কলা ভর্তা : 20 টাকা", value: "a139", sellingPrice: 20, actualPrice: 20 },	//Unofficial
		    //  Pacakge
		     { label: "প্যাকেজ-০১: পরোটা ২পিস+সবজি+ডিম+কফি = 130 টাকা", value: "a140", sellingPrice: 130, actualPrice: 130 },
		     { label: "প্যাকেজ-০২: পরোটা ২ পিস+সবজি+ডিম+মুরগী(২/৮)+কফি = 280 টাকা", value: "a141", sellingPrice: 280, actualPrice: 280 },
		     { label: "প্যাকেজ-০৩: ভাত (কাটারি)+মাছ(রুই/কাতলা)/মুরগী(১/৪)+সবজি+ডাল+সালাদ+ফিরনি/দই/ড্রিংকস = 315 টাকা", value: "a142", sellingPrice: 315, actualPrice: 315 },
		     { label: "প্যাকেজ-০৪: ফ্রাইড রাইস+ চিকেন ফ্রাই+ চাইনিজ সবজি+বেগুন ভাজি+সালাদ+ফিরনি/দই/ড্রিংকস =  410 টাকা", value: "a143", sellingPrice: 410, actualPrice: 410  },
		     { label: "প্যাকেজ-০৫: ভাত (কাটারি)+মাছ (রুই/কাতলা) + মুরগী(১/৪) + সবজি + ডাল+ সালাদ+ ফিরনি/দই/ড্রিংকস = 455 টাকা", value: "a144", sellingPrice: 455, actualPrice: 455 },
		     { label: "প্যাকেজ-০৬: ভাত (কাটারি)+ মাছ(রুই/কাতলা)+মাটন(১/৫)+ সবজি +ডাল + সালাদ + ফিরনি/দই/ড্রিংকস = 655 টাকা", value: "a145", sellingPrice: 655, actualPrice: 655 },
		     { label: "প্যাকেজ-০৭: মাটন তেহারী+মাছ ভাজা(রুই/কাতলা)+সালাদ+ফিরনি/দই/ড্রিংকস = 615 টাকা", value: "a146", sellingPrice: 615, actualPrice: 615 },
		     { label: "প্যাকেজ-০৮: পোলাও+চিকেন রোস্ট(১/৪)+মাটন রেজালা(১/৫)+মাটন কাবাব+সবজি+সালাদ+ফিরনি/দই/ড্রিংকস = 795 টাকা", value: "a147", sellingPrice: 795, actualPrice: 795 },
		     { label: "প্যাকেজ-০৯: পোলাও+চিকেন রোস্টা(১/৪)+মাটন রেজালা(১/৫)+সবজি+মাটন কাবাব+বোরহানি+সালাদ +ফিরনি/দই/ড্রিংকস = 850 টাকা", value: "a148", sellingPrice: 850, actualPrice: 850 },
		     { label: "প্যাকেজ-০১০: মোরগ পোলাও(মুরগী ১/৪ পিস)+ ডিম ১ পিস+মাটন কাবাব+মাছ ভাজা(রুই/কাতলা)+সালাদ+ফিরনি/দই/ড্রিংকস = 590 টাকা", value: "a149", sellingPrice: 590, actualPrice: 590 },
		     { label: "প্যাকেজ-০১১: মোরগ পোলাও(মুরগী 2/৪ পিস)+ ডিম ১ পিস+মাটন কাবাব+মাছ ভাজা(রুই/কাতলা)+সালাদ+ফিরনি/দই/ড্রিংকস = 760 টাকা", value: "a150", sellingPrice: 760, actualPrice: 760 },
		     { label: "প্যাকেজ-০১২: কাচ্চি বিরিয়ানি(১/৩)+ডিম ১ পিস+চিকেন রোস্ট(১/৪)+মাটন কাবাব+বোরহানি+সালাদ+ফিরনি/দই/ড্রিংকস = 975 টাকা", value: "a151", sellingPrice: 975, actualPrice: 975 },
		     { label: "প্যাকেজ-০১৩: ফ্রাইড রাইস+চিকেন রোস্ট(১/৪)+চাইনিজ সবজি+চিংড়ি চিলি কারি+বেগুন ভাজি+সালাদ+ফিরনি/দই/ড্রিংকস = 740 টাকা", value: "a152", sellingPrice: 740, actualPrice: 740 },
		     { label: "প্যাকেজ-০১৪: পোলাও চাল এবং মুগ ডালের খিচুড়ি+ মুরগীর কারি+ ইলিশ ফ্রাই+ সবজি+আচার+সালাদ+ ফিরনি/দই/ড্রিংকস= 650 টাকা", value: "a153", sellingPrice: 650, actualPrice: 650 },
           
            // Unofficial Items
		

			
			{ label: "টাকিমাছ ভর্তা : 30 টাকা", value: "a154", sellingPrice: 30, actualPrice: 27 },
			{ label: "সীম ভর্তা : 20 টাকা", value: "a155", sellingPrice: 20, actualPrice: 20 },

			{ label: "লাউডাল : 35 টাকা", value: "a156", sellingPrice: 35, actualPrice: 30 },
			{ label: "লাউচিংড়ি : 40 টাকা", value: "a157", sellingPrice: 40, actualPrice: 35 },
			{ label: "পুইশাক মিষ্টি কুমড়া : 35 টাকা", value: "a158", sellingPrice: 35, actualPrice: 30 },
			{ label: "পেপে ভর্তা : 20 টাকা", value: "a159", sellingPrice: 20, actualPrice: 20 },
			{ label: "আলু ভর্তা : 20 টাকা", value: "a160", sellingPrice: 20, actualPrice: 20 },
			{ label: "মিষ্টি কুমড়া ভর্তা : 20 টাকা", value: "a161", sellingPrice: 20, actualPrice: 20 },
			{ label: "কালোজাম মিষ্টি : 50 টাকা", value: "a162", sellingPrice: 50, actualPrice: 50 },
			{ label: "লেক্সাস বিস্কুট : 15 টাকা", value: "a163", sellingPrice: 15, actualPrice: 9 },
			{ label: "ডাবের পানি : 120 টাকা", value: "a164", sellingPrice: 120, actualPrice: 120 },
			{ label: "রুটি : 15 টাকা", value: "a165", sellingPrice: 15, actualPrice: 10 },
			{ label: "ভর্তা (আলু,পটল,ঢ়েড়স,পেপে,বেগুন..) : 20 টাকা", value: "a166", sellingPrice: 20, actualPrice: 20 },
			{ label: "চিংড়ি মাছ ভর্তা : 30 টাকা", value: "a167", sellingPrice: 30, actualPrice: 30 },
			{ label: "থাই স্যুপ : 120 টাকা", value: "a168", sellingPrice: 120, actualPrice: 120 },
			{ label: "অন্থন ১পিস : 50 টাকা", value: "a169", sellingPrice: 50, actualPrice: 50 },
			{ label: "কেশিউনাট সালাদ : 100 টাকা", value: "a170", sellingPrice: 100, actualPrice: 100 },
			{ label: "পেপের জুস : 50 টাকা", value: "a171", sellingPrice: 50, actualPrice: 40 },
			{ label: "করলা চিংড়ি ফ্রাই : 40 টাকা", value: "a172", sellingPrice: 40, actualPrice: 40 },
			{ label: "চিকেন মমো : 65 টাকা", value: "a173", sellingPrice: 65, actualPrice: 50 },
			{ label: "প্যাকেট + ব্যাগ : 25 টাকা", value: "a174", sellingPrice: 25, actualPrice: 20 },
			{ label: "প্যাকেট : 15 টাকা", value: "a175", sellingPrice: 15, actualPrice: 12 },
			{ label: "ব্যাগ (বিয়াম) : 10 টাকা", value: "a176", sellingPrice: 10, actualPrice: 8 }
        ];
    ...
    priceList.forEach(item => {
        ...
        function updateSelectedItemsList() {
            ...
            for (var i = 0; i < selectedItems.length; i++) {
                ...
                vat = sellingTotal*0.15;
                svc = sellingTotal*0.05;
                grandTotal = sellingTotal+vat+svc;
            }

            // Update total prices
            $("#sellingTotal").text(sellingTotal.toFixed(2));
            $("#vat").text(vat.toFixed(2));
            $("#service").text(svc.toFixed(2));
